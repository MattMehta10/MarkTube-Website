  ...
  return (
    <>
            ...
            <motion.section initial={{opacity:0}} animate={{opacity:1}} transition={{duration:.8,delay:.2}} className="grid grid-cols-2 lg:grid-cols-4 relative gap-y-3 lg:gap-6 mb-4">
                <div className='text-white font-[gilroyE] absolute top-0 lg:relative font-normal lg:w-61 lg:h-20 lg:text-[23px] items-center flex p-2'>
        ...
        <div className='font-[gilroyE] relative border-l bg-radial from-gray-700/20 from-0% to-gray-950/20 border-b border-gray-50/12 bg-gray-50/5 lg:hover:bg-green-600/25 transition ease-in-out duration-300 flex justify-center font-extrabold rounded-xl text-2xl w-17 h-20'>
          <h1 className='pt-3'>{Libdata.watched.length}</h1>
          <p className='absolute bottom-2 text-[12px]'>Watched</p>
        </div>
        <div className='font-[gilroyE] relative border-l bg-radial from-gray-700/20 from-0% to-gray-950/20 border-b border-gray-50/12 bg-gray-50/5 lg:hover:bg-red-600/25 transition ease-in-out duration-300 flex justify-center font-extrabold rounded-xl text-2xl w-17 h-20'>
          <h1 className='pt-3'>{Libdata.important.length}</h1>
          <p className='absolute bottom-2 text-[12px]'>Important</p>
        </div>
        <div className='font-[gilroyE] relative border-l bg-radial from-gray-700/20 from-0% to-gray-950/20 border-b border-gray-50/12 bg-gray-50/5 lg:hover:bg-yellow-400/25 flex transition ease-in-out duration-300 justify-center font-extrabold rounded-xl text-2xl w-17 h-20'>
          <h1 className='pt-3'>{Libdata.toWatch.length}</h1>
          <p className='absolute bottom-2 text-[12px]'>Pending</p>
        </div>
      </div>
              <div className="lg:h-36 h-33 w-25 font-[gilroyE] font-normal lg:ml-1 ml-16 lg:pt-0 pt-12 lg:w-full border-2 border-gray-50/12 p-6 rounded-2xl bg-radial from-gray-700/50 from-10% to-gray-950/30 shadow-lg flex flex-col justify-center lg:justify-between items-center">
                <h4 className="text-lg lg:mb-0 -mb-5  text-white">Streak</h4>
              ...
              <div className="h-36 lg:col-span-1 font-[gilroyE] font-normal col-span-2 border-2 border-gray-50/12 p-6 rounded-2xl bg-radial from-gray-700/50 from-10% to-gray-950/30 shadow-lg flex flex-col justify-center items-center">
                <h4 className="text-lg mb-2 font-bold text-white">Activity</h4>
                <p className="text-white">📊 Weekly Progress</p>
              </div>
            </motion.section>

  <div className='flex font-normal relative font-[gilroyE] flex-col gap-5 w-full h-100 p-5 items-start rounded-2xl border border-gray-50/12 bg-radial from-gray-700/30 from-10% to-gray-950/30'>
  ...
  style={{
    ...
    {video.title}
      ...
      <motion.div initial={{y:50,opacity:0}} animate={{y:0,opacity:1}} transition={{duration:.5,delay:.5}} className='w-full'>
        ...
        <div className="mt-2 w-full h-35 border font-[gilroyE] font-normal border-gray-50/12 rounded-3xl overflow-hidden">
