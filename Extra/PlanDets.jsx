...
const PlanDets = () => {
  ...
  return ( 
    <div className='p-10'> <h1 className='text-5xl text-yellow-300 font-extrabold'>{name}</h1> 
     ...
     <button onClick={()=>navigate(-1)} className='bg-emerald-400 p-2 rounded-lg' ><h3>Go Back</h3></button>
      
    </div>
  )
}

export default PlanDets